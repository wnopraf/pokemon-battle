...
function BattlePageStoryWrapper({ teams = [], selection = null }) {
  useEffect(() => {
    ...
    useBattleStore.setState({ battleResult: null });
  ...
  return (
    <MemoryRouter initialEntries={["/battle/play"]}>
...
export const EmptySelection = {
  render: () => <BattlePageStoryWrapper teams={[]} selection={null} />,
};
